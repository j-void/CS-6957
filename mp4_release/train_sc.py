...
def run_hidden(model, tokenizer, save_path):
    ...
    tokenized_inp = tokenizer(text, truncation=True ,padding=True ,return_tensors ='pt', max_length=cfg.max_length)
...
if __name__ == "__main__":
    ...
    train_dataset = SSTDataset(tokenizer=tokenizer, max_length=cfg.max_length, split='train')
    val_dataset = SSTDataset(tokenizer=tokenizer, max_length=cfg.max_length, split='validation')
    test_dataset = SSTDataset(tokenizer=tokenizer, max_length=cfg.max_length, split='test')
